...
namespace snt::dip {
    ...
    class ValueNode : virtual public BaseNode {
      ...
      public:
        ...
        ValueNode(const Path& pth, val::BaseValue::PointerType val, std::optional<puq::Quantity> unt = std::nullopt);
        ...
        virtual ValueNode::PointerType clone(const Path& pth) const = 0;
