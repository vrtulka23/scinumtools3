    ...
    template <typename ATOM, typename VALUE> class AtomBase : public AtomGrand {
      public:
        ...
        virtual void math_subtract(ATOM* other) {
            throw exs::MissingException("Atom method 'math_subtract' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void math_multiply(ATOM* other) {
            throw exs::MissingException("Atom method 'math_multiply' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void math_divide(ATOM* other) {
            throw exs::MissingException("Atom method 'math_divide' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void math_power(ATOM* other) {
            throw exs::MissingException("Atom method 'math_power' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void math_modulo(ATOM* other) {
            throw exs::MissingException("Atom method 'math_modulo' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void math_logarithm_base(ATOM* other) {
            throw exs::MissingException("Atom method 'math_logarithm_base' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void math_power_base(ATOM* other) {
            throw exs::MissingException("Atom method 'math_power_base' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void comparison_equal(ATOM* other) {
            throw exs::MissingException("Atom method 'comparison_equal' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void comparison_not_equal(ATOM* other) {
            throw exs::MissingException("Atom method 'comparison_not_equal' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void comparison_less_equal(ATOM* other) {
            throw exs::MissingException("Atom method 'comparison_less_equal' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void comparison_greater_equal(ATOM* other) {
            throw exs::MissingException(
                "Atom method 'comparison_greater_equal' is not implemented", __FILE__, __LINE__
            );
        };
        ...
        virtual void comparison_less(ATOM* other) {
            throw exs::MissingException("Atom method 'comparison_less' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void comparison_greater(ATOM* other) {
            throw exs::MissingException("Atom method 'comparison_greater' is not implemented", __FILE__, __LINE__);
        };
        ...
        virtual void condition(ATOM* option1, ATOM* option2) {
            throw exs::MissingException("Atom method 'condition' is not implemented", __FILE__, __LINE__);
        };
