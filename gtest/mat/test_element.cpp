...
TEST(Element, Nucleons) {
  ...
  EXPECT_EQ(element.mass.to_string(), "{m_p}");
  ...
  EXPECT_EQ(element.mass.to_string(), "{m_n}");
  ...
  EXPECT_EQ(element.mass.to_string(), "{m_e}");
  EXPECT_EQ(element.protons,   0);
  EXPECT_EQ(element.neutrons,  0);
...
TEST(Element, Isotopes) {
  ...
  EXPECT_EQ(element.mass.to_string(), "1.00783*u");
  EXPECT_EQ(element.protons,   1);
  EXPECT_EQ(element.neutrons,  0);
  EXPECT_EQ(element.electrons, 1);
  ...
  EXPECT_EQ(element.mass.to_string(), "2.0141*u");
  EXPECT_EQ(element.protons,   1);
  EXPECT_EQ(element.neutrons,  1);
  EXPECT_EQ(element.electrons, 1);
  ...
  EXPECT_EQ(element.mass.to_string(), "3.01605*u");
  EXPECT_EQ(element.protons,   1);
  ...
  EXPECT_EQ(element.mass.to_string(), "23.985*u");
  EXPECT_EQ(element.protons,   12);
  EXPECT_EQ(element.neutrons,  12);
  EXPECT_EQ(element.electrons, 12);

  element = mat::Element("Hg{202}");
  EXPECT_EQ(element.to_string(), "Hg{202}");
  EXPECT_EQ(element.mass.to_string(), "201.971*u");
  EXPECT_EQ(element.protons,   80);
  EXPECT_EQ(element.neutrons,  122);
  EXPECT_EQ(element.electrons, 80);

  element = mat::Element("Cm{245}");
  EXPECT_EQ(element.to_string(), "Cm{245}");
  EXPECT_EQ(element.mass.to_string(), "245.065*u");
  EXPECT_EQ(element.protons,   96);
  EXPECT_EQ(element.neutrons,  149);
  EXPECT_EQ(element.electrons, 96);
...
TEST(Element, NaturalAbundance) {
  ...
  EXPECT_EQ(element.mass.to_string(), "1.00794*u");
  EXPECT_EQ(element.protons,   1);
  EXPECT_EQ(element.neutrons,  0.000115);
  EXPECT_EQ(element.electrons, 1);

  element = mat::Element("Mg");  
  EXPECT_EQ(element.to_string(), "Mg");
  EXPECT_EQ(element.mass.to_string(), "24.3051*u");
  EXPECT_EQ(element.protons,   12);
  ...
  EXPECT_EQ(element.mass.to_string(), "200.599*u");
  EXPECT_EQ(element.protons,     80);
  EXPECT_NEAR(element.neutrons,  120.629, 1e-3);
  EXPECT_EQ(element.electrons,   80);
