...
namespace val {
  ...
  public:
    ...
    virtual BaseValue::PointerType cast_as(ValueDtype dt) const = 0;
...
namespace val {  
  ...
  BaseValue::PointerType create_array_value(const std::vector<T>&  arr, Array::ShapeType sh={}) {
    ...
    if constexpr (std::is_same_v<T, bool>)
      ...
      return std::make_unique<ArrayValue<int16_t>>(ArrayValue<int16_t>(arr, sh, ValueDtype::Integer16));
    else if constexpr (std::is_same_v<T, uint16_t>)
      return std::make_unique<ArrayValue<uint16_t>>(ArrayValue<uint16_t>(arr, sh, ValueDtype::Integer16_U));
    else if constexpr (std::is_same_v<T, int32_t>)
      return std::make_unique<ArrayValue<int32_t>>(ArrayValue<int32_t>(arr, sh, ValueDtype::Integer32));
    else if constexpr (std::is_same_v<T, uint32_t>)
      return std::make_unique<ArrayValue<uint32_t>>(ArrayValue<uint32_t>(arr, sh, ValueDtype::Integer32_U));
    else if constexpr (std::is_same_v<T, int64_t>)
      return std::make_unique<ArrayValue<int64_t>>(ArrayValue<int64_t>(arr, sh, ValueDtype::Integer64));
    else if constexpr (std::is_same_v<T, uint64_t>)
      return std::make_unique<ArrayValue<uint64_t>>(ArrayValue<uint64_t>(arr, sh, ValueDtype::Integer64_U));
