...
namespace dip {
  ...
  class ValueNode: virtual public BaseNode {
    ...
    virtual val::BaseValue::PointerType cast_array_value(const Array::StringType& value_inputs, const Array::ShapeType& shape) const = 0;
  protected:
    struct OptionStruct {
  ...
  public:
    ...
    val::BaseValue::PointerType cast_value(Array::StringType& value_input, const Array::ShapeType& shape);
  ...
  class BooleanNode: public ValueNode {
    ...
    val::BaseValue::PointerType cast_array_value(const Array::StringType& value_inputs, const Array::ShapeType& shape) const override;
  public:
    static BaseNode::PointerType is_node(Parser& parser);
    BooleanNode(const std::string& nm, val::BaseValue::PointerType val): BaseNode(NodeDtype::Boolean), ValueNode(nm, std::move(val), val::DataType::Boolean) {};
  ...
  public:
    static BaseNode::PointerType is_node(Parser& parser);
    StringNode(const std::string& nm, val::BaseValue::PointerType val): BaseNode(NodeDtype::String), ValueNode(nm, std::move(val), val::DataType::String) {};
    StringNode(Parser& parser): BaseNode(parser, NodeDtype::String), ValueNode(val::DataType::String) {};
    BaseNode::NodeListType parse(Environment& env) override;
    BaseNode::PointerType clone(const std::string& nm) const override;
    bool set_property(PropertyType property, Array::StringType& values, std::string& units) override;
  ...
  public:
    ...
    static BaseNode::PointerType is_node(Parser& parser);
    IntegerNode(const std::string& nm, val::BaseValue::PointerType val, const val::DataType vdt): BaseNode(NodeDtype::Boolean), ValueNode(nm, std::move(val), vdt) {};
  ...
  public:
    ...
    static BaseNode::PointerType is_node(Parser& parser);
    FloatNode(const std::string& nm, val::BaseValue::PointerType val, const val::DataType vdt): BaseNode(NodeDtype::Float), ValueNode(nm, std::move(val), vdt) {};
  ...
  BaseNode::PointerType create_scalar_node(const std::string& name, const T value) {
    val::BaseValue::PointerType ptr_value = std::make_unique<val::ArrayValue<T>>(value);
    if constexpr (std::is_same_v<T, bool>)
      return std::make_shared<BooleanNode>(name, std::move(ptr_value));
    else if constexpr (std::is_same_v<T, short>)
      return std::make_shared<IntegerNode>(name, std::move(ptr_value), val::DataType::Integer16);
    else if constexpr (std::is_same_v<T, unsigned short>)
      return std::make_shared<IntegerNode>(name, std::move(ptr_value), val::DataType::Integer16_U);
    else if constexpr (std::is_same_v<T, int>)
      return std::make_shared<IntegerNode>(name, std::move(ptr_value), val::DataType::Integer32);
    else if constexpr (std::is_same_v<T, unsigned int>)
      return std::make_shared<IntegerNode>(name, std::move(ptr_value), val::DataType::Integer32_U);
    else if constexpr (std::is_same_v<T, long long>)
      return std::make_shared<IntegerNode>(name, std::move(ptr_value), val::DataType::Integer64);
    else if constexpr (std::is_same_v<T, unsigned long long>)
      return std::make_shared<IntegerNode>(name, std::move(ptr_value), val::DataType::Integer64_U);
    else if constexpr (std::is_same_v<T, float>)
      return std::make_shared<FloatNode>(name, std::move(ptr_value), val::DataType::Float32);
    else if constexpr (std::is_same_v<T, double>)
      return std::make_shared<FloatNode>(name, std::move(ptr_value), val::DataType::Float64);
    else if constexpr (std::is_same_v<T, long double>)
      return std::make_shared<FloatNode>(name, std::move(ptr_value), val::DataType::Float128);
  ...
  BaseNode::PointerType create_array_node(const std::string& name, const std::vector<T>&  arr, Array::ShapeType sh={}) {
    ...
    val::BaseValue::PointerType ptr_value = std::make_unique<val::ArrayValue<T>>(arr, sh);
    if constexpr (std::is_same_v<T, bool>)
      return std::make_shared<BooleanNode>(name, std::move(ptr_value));
    else if constexpr (std::is_same_v<T, short>)
      return std::make_shared<IntegerNode>(name, std::move(ptr_value), val::DataType::Integer16);
