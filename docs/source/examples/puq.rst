...
.. code-block:: c
   ...
   snt_puq_quantity_eval("2.5*m", &quantity, &error);
   snt_puq_quantity_convert(quantity, "cm", &converted, &error);
   snt_puq_quantity_format(converted, output, sizeof(output), &error);
