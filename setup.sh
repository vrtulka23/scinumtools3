...
CMAKE_FLAGS+="-DCOMPILE_VAL=OFF -DCOMPILE_TESTS_VAL=OFF "
CMAKE_FLAGS+="-DCOMPILE_PUQ=OFF -DCOMPILE_TESTS_PUQ=OFF -DCOMPILE_PUQ_MAGNITUDE=value "
CMAKE_FLAGS+="-DCOMPILE_DIP=OFF -DCOMPILE_TESTS_DIP=OFF "
CMAKE_FLAGS+="-DCOMPILE_MAT=OFF -DCOMPILE_TESTS_MAT=OFF "
OS="$(uname -s)"
