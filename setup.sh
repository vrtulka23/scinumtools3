...
CMAKE_FLAGS="-DCOMPILE_EXS=ON -DCOMPILE_GTESTS_EXS=ON "
CMAKE_FLAGS+="-DCOMPILE_VAL=ON -DCOMPILE_GTESTS_VAL=ON "
CMAKE_FLAGS+="-DCOMPILE_PUQ=ON -DCOMPILE_GTESTS_PUQ=ON -DCOMPILE_PUQ_MAGNITUDE=value "
CMAKE_FLAGS+="-DCOMPILE_DIP=ON -DCOMPILE_GTESTS_DIP=ON "
CMAKE_FLAGS+="-DCOMPILE_MAT=OFF -DCOMPILE_GTESTS_MAT=OFF "
OS="$(uname -s)"
