...
TEST(StringFormat, Integers) {
  ...
  EXPECT_EQ(core::number_to_string(int(123)), "123");
  EXPECT_EQ(core::number_to_string(int(4567890)), "4567890");
  EXPECT_EQ(core::number_to_string(int(-123)), "-123"); // negative values

  EXPECT_EQ(core::number_to_string(int(123), int(2)), "123(2)");
  EXPECT_EQ(core::number_to_string(int(4567890), int(234)), "456789(23)e1");
...
TEST(StringFormat, Floats) {
  ...
  EXPECT_EQ(core::number_to_string(double(1.23456789e-23)), "1.235e-23");
  EXPECT_EQ(core::number_to_string(double(0.00000123456789)), "1.235e-6");
  EXPECT_EQ(core::number_to_string(double(0.00123456789)), "1.235e-3");
  EXPECT_EQ(core::number_to_string(double(0.0123456789)), "0.01235");
  EXPECT_EQ(core::number_to_string(double(1.23456789)), "1.235");
  EXPECT_EQ(core::number_to_string(double(123.456789)), "123.5");
  EXPECT_EQ(core::number_to_string(double(1234.56789)), "1.235e3");
  EXPECT_EQ(core::number_to_string(double(1234567.89)), "1.235e6");
  EXPECT_EQ(core::number_to_string(double(1.23456789e23)), "1.235e23");

  EXPECT_EQ(core::number_to_string(double(0.00123456789), double(0.000012)), "1.235(12)e-3");
  EXPECT_EQ(core::number_to_string(double(12.67), double(0.02)), "1.2670(20)e1");
  EXPECT_EQ(core::number_to_string(double(12345.67), double(2.23)), "1.23457(22)e4");

  core::StringFormatType prec;
  prec.uncertaintyPrecision = 3;
  EXPECT_EQ(core::number_to_string(double(12.3456), double(0.123), prec), "1.2346(123)e1"); // higher precision
}
